  ...
  Future filexMap() async {
    ...
    if (response.statusCode == 200) {
      ...
      result.forEach((key, value) {
        ...
        print(currencies.length);
        print(currencies.toString()); // [docs, docs, value]
        var iteratorx = currencies.iterator;
        print(iteratorx.toString());
        currencies.forEach((element) {
          print(element);
        });
        currencies.add('1');
        currencies.insert(2,'deniz');
        currencies.forEach((element) {
          print(index.toString()+'   '+element);
          index++;
        });
      });
